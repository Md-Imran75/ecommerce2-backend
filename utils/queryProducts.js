class queryProducts {
    ...
    modelQuery = () => {
        this.products = this.query.model ? this.products.filter(c => c.model === this.query.model) : this.products
        return this
    }
    brandQuery = () => {
        this.products = this.query.brand ? this.products.filter(c => c.brand === this.query.brand) : this.products
        return this
    }
    priceQuery = () => {
